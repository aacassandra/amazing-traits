...
class m_approval_d_configs extends Model
{
    ...
    public function __construct($attr = array(), $exists = false) {
        ...
        $this->table = env('TABLE_PREFIX') . 'm_approval_d_configs';
    }

    protected $casts = [
        'is_full_approve' => 'boolean',
        'is_skippable' => 'boolean',
        'is_able_to_skip' => 'boolean',
        'send_wa_notif' => 'boolean',
        'send_email_notif' => 'boolean',
    ];
