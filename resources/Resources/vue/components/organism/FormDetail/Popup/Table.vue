    ...
    <div class="col-span-12">
      ...
      >
        <vue-good-table-custom
          ...
          :line-numbers="options.tableConfigs?.lineNumbers"
...
<script setup lang="ts">
  ...
  import { AddRowFromPopupOptions, FormDetail } from '~/types/form/detail'
  ...
  const temp = inject('temp') as { form: FormDetail }
  ...
  const parentMethods = inject('dtlParentMethods') as any
  const methods = {
    onSearch: () => {
      //
    },
