...
<script setup lang="ts">
  ...
  const landingRoute = 'setup-master-categories'
    ...
    tabs: [
      {
        key: 'tab1',
        label: 'Detail',
        icon: '<i class="fa-light fa-eye"></i>',
        active: true,
      },
    ],
  })
