    ...
    <Card>
      <template #card-header>
        <div class="flex">
          ...
          <div
            v-if="
              CheckPermissions(['cluster-master-admins-create'], permissions)
            "
            class="fle-grow-0"
          >
...
<script setup lang="ts">
  ...
  const pageConfigs = reactive<PageConfigs>({
    ...
    formRoute: 'cluster-master-admins-form',
  })
  ...
  const data = reactive<DataLanding>({
    ...
    actions: {
      ...
      edit: () => {
        if (
          !CheckPermissions(['cluster-master-admins-edit'], permissions.value)
        ) {
          Notyf({
            type: 'warning',
            message: "You don't have permission",
      ...
      delete: () => {
        if (
          !CheckPermissions(['cluster-master-admins-delete'], permissions.value)
        ) {
          Notyf({
            type: 'warning',
            message: "You don't have permission",
